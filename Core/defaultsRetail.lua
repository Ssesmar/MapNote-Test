...
ns.defaults = {
    profile = { -- ns.Addon.db.profile.show (without a point at the end of show)
      ...
      --Capitals Minimap
        ...
        showMinimapCapitalEnemyFaction = true,
        ...
        showMinimapShattrath = true,
        showMinimapDalaranNorthrend = true,
        showMinimapDalaranLegion = true,
        showMinimapSot2M = true,
        showMinimapSot7S = true,
        showMinimapStormshield = true,
        showMinimapWarspear = true,
        showMinimapDazarAlor = true,
        showMinimapBoralus = true,
        showMinimapOribos = true,
        showMinimapValdrakken = true,
        --Capital Minimap General
        showMinimapCapitalsMapNotes = true,
        CapitalsMinimapGeneralScale = 1,
        CapitalsMinimapGeneralAlpha = 1,        
        showMinimapCapitalsHearthstone = true,
        showMinimapCapitalsAuctioneer = true,
        showMinimapCapitalsGeneral = true,
        showMinimapCapitalsPaths = true,
        showMinimapCapitalsBank = true,
      --Capital Minimap Instances
        showMinimapCapitalsInstances = true,
      ...
      --Capital Minimap Transport
        showMinimapCapitalsTransporting = true,
      ...
      -- Capital Minimap Professions
        ...
        show = { --0 ns.Addon.db.profile.show. (with a point at the end of show)

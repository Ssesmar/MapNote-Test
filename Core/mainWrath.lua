...
function MapNotesMiniButton:OnInitialize() --mmb.lua
  self.db = LibStub("AceDB-3.0"):New("MNMiniMapButtonWrathDB", { profile = { minimap = { hide = false, }, }, }) 
...
function Addon:PLAYER_LOGIN()
  ...
  self.db = LibStub("AceDB-3.0"):New("HandyNotes_MapNotesWrathDB", ns.defaults, true)
  db = self.db.profile
...
function Addon:PopulateTable()
  ...
  ns.LoadWrathMiniMapInfo(self) -- load nodes\Wrath\WrathMiniMapInfo.lua
  ns.LoadWrathZoneInfo(self) -- load nodes\Wrath\WrathWorldMapInfo.lua
  ns.LoadWrathContinentInfo(self) -- load nodes\Wrath\WrathContinentInfo.lua
  ns.LoadWrathWorldMapInfo(self) -- load nodes\Wrath\WrathWorldMapInfo.lua
end

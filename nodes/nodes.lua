...
--function ns.Addon:LoadNodes() -- Fizz Added
--local db = ns.Addon.db.profile -- Fizz moved and changed
	local nodes = { }
  ns.nodes = nodes
    ...
    --Inside Dungeon MapNotes
      ...
      --Outland
          nodes[340][21756343] = { uiMapID = 104, name = L["Exit"], type = "Exit", showInZone = true } -- Black Temple exit

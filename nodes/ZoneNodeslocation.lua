      ...
      if db.show.ZoneMap then
        ...
        --Kalimdor Zeppelins
          if self.db.profile.showZoneZeppelins then
            nodes[85][45466142] = { mnID = 114, name = "", type = "HZeppelin", showInZone = true, hideOnContinent = true } -- Zeppelin from OG to Borean Tundra - Northrend
            nodes[85][42796534] = { mnID = 88, name = "", type = "HZeppelin", showInZone = true, hideOnContinent = true } -- Zeppelin from OG to Thunder Bluff
            nodes[85][52975228] = { mnID = 50, name = "", type = "HZeppelin", showInZone = true, hideOnContinent = true } -- Zeppelin from OG to Thunder Bluff
          end

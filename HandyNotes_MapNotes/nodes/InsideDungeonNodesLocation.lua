...
if not db.show.HideMapNote then
    ...
    if db.show.DungeonMap then
        ...
        --##########################
          ...
          --Hour of Twillight
            nodes[399][50167120] = { mnID = 400, name = L["Passage"], type = "PassageDownL", showInZone = true } -- Hour of Twillight
        ...
        --###################################
          --Dragon Soul
            nodes[411][57698846] = { upID = 409, name = "", type = "Portal", showInZone = true } -- to Maw of Shu'ma
            nodes[410][23324020] = { upID = 409, name = "", type = "Portal", showInZone = true } -- to Maw of Go'rath
            nodes[412][52181359] = { upID = 409, name = "", type = "Portal", showInZone = true } -- to Eye of Eternity
            nodes[409][50606029] = { upID = 412, mnID = 412, name = "", type = "Portal", showInZone = true } -- Dragon Soul to Eye of Eternity
          --End Time
            nodes[401][79774484] = { upID = 403, mnID = 403, name = "", type = "Portal", showInZone = true } -- End Time - 
            nodes[403][33054295] = { upID = 402, mnID = 401, name = "", type = "Portal", showInZone = true } -- End Time - to Ruby Dragonshrine
            nodes[402][41428063] = { upID = 402, mnID = 401, name = "", type = "Portal", showInZone = true } -- End Time - to Azure Dragonshrine
            nodes[402][41428063] = { upID = 402, mnID = 401, name = "", type = "Portal", showInZone = true } -- End Time - to Azure Dragonshrine
        --##########################################

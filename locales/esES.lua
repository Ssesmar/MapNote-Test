...
L["Resizes symbols on the azeroth, continent, zone, dungeon and minimap"] = "Cambie el tamaño de los símbolos a Azeroth, Continente, Zona, Dungeon y Mini Card"
L["symbol visibility"] = "Simbolismo"
L["Changes the visibility of the symbols"] = "Cambia la quince de los símbolos"
...
L["Exodar"] = "Exodar"
L["Eastern Plaguelands"] = "Plaguelands oriental"
...
L["Lion's Watch"] = "Guardia de león"
...
L["This Arathi Highlands portal is only active if your faction is currently occupying Ar'gorok"] = "Este portal de Arathi -Hochland solo está activo si su facción está actualmente ocupada por Ar'gorok"
L["This Darkshore portal is only active if your faction is currently occupying Bashal'Aran"] = "Este portal de la costa oscura solo está activa si su facción está actualmente ocupada por Bashal'aran"
...
L["Old version of Scarlet Monastery Armory \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"] = " Versión antigua de la Armería del Monasterio Escarlata \n (es necesario activar el [Llavero antiguo] en 48.33 55.88 dentro del Monasterio Escarlata)"
L["Old version of Scholomance - Secret Entrance \n (Memory of Scholomance - Achievement)"] = " Versión antigua de Scholomance - Entrada secreta \n (Memoria de Scholomance - Logro)"

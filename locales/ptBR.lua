...
L["Exodar"] = "Exodar"
L["Eastern Plaguelands"] = "Plaguelândia Oriental"
...
L["This Arathi Highlands portal is only active if your faction is currently occupying Ar'gorok"] = "Este portal Arathi-Hochland só está ativo se sua facção estiver ocupada atualmente por Ar'gorok"
L["This Darkshore portal is only active if your faction is currently occupying Bashal'Aran"] = "Este portal da costa escura só está ativo se sua facção estiver ocupada por Bashal'aran"

--7 old dungeons/raids
L["Old version of Scarlet Monastery Armory \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"] = "Versão antiga do Scarlet Monastery Armory \n (é necessário ativar o [Antigo Chaveiro] em 48.33 55.88 dentro do Scarlet Monastery)"
    L["Old version of Naxxramas - Secret Entrance \n (Wards of the Dread Citadel - Achievement)"] = " Versão antiga de Naxxramas - Entrada Secreta \n (Wards of the Dread Citadel - Conquista)"
    L["Old version of Scarlet Monastery Cathedral \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"] = " Versão antiga da Catedral do Monastério Escarlate \n (é necessário ativar o [Chaveiro Antigo] em 48.33 55.88 dentro do Monastério Escarlate)"
    L["Old version of Scarlet Monastery Graveyard \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"]  " Versão antiga do Cemitério do Monastério Escarlate \n (é necessário ativar o [Chaveiro Antigo] em 48.33 55.88 dentro do Monastério Escarlate"
    L["Old version of Scarlet Monastery Library \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"] = " Versão antiga da Biblioteca do Monastério Escarlate \n (é necessário ativar o [Chaveiro Antigo] em 48.33 55.88 dentro do Monastério Escarlate)"
    L["Old version of Scarlet Monastery Armory \n (need to activate the [Old Keychain] at 48.33 55.88 inside the Scarlet Monastery)"] = " Versão antiga do Scarlet Monastery Armory \n (é necessário ativar o [Antigo Chaveiro] em 48.33 55.88 dentro do Scarlet Monastery)"
    L["Old version of Scholomance - Secret Entrance \n (Memory of Scholomance - Achievement)"] = " Versão antiga de Scholomance - Entrada Secreta \n (Memória de Scholomance - Conquista)"

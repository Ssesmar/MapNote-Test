...
L["These portals are only active in the game if your faction is currently occupying (Ar'gorok for the Arathi Highlands portal) or (Bashal'Aran for the Darkshore portal)"] = "Estos portales sólo están activos en el juego si tu facción está ocupando (Ar'gorok para el portal de Arathi Highlands) o (Bashal'Aran para el portal de Darkshore)" 

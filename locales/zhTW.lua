...
L["These portals are only active in the game if your faction is currently occupying (Ar'gorok for the Arathi Highlands portal) or (Bashal'Aran for the Darkshore portal)"] = "只有當你的陣營目前正在佔領（阿拉希高地傳送門的阿爾戈羅克）或黑海岸傳送門的巴沙爾阿蘭時，這些傳送門才會在遊戲中處於活動狀態" 

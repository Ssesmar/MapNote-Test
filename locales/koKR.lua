...
L["Portal to Zandalar(horde)/Boralus(alliance)"] = "잔달라(호드)/보랄러스(얼라이언스)로 통하는 차원문"
...
L["These portals are only active in the game if your faction is currently occupying (Ar'gorok for the Arathi Highlands portal) or (Bashal'Aran for the Darkshore portal)"] = "이 차원문은 귀하의 세력이 현재 (아라시 고원 차원문의 경우 아르고록) 또는 (어둠해안 차원문의 경우 바샬아란)을 점유하고 있는 경우에만 게임에서 활성화됩니다." 

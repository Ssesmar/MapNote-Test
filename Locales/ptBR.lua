...
--0 Restore
L["Delete icon permanently?"] = "Excluir o símbolo?"
...
L["which you removed with Alt + middle mouse button function"] = "que você removeu com a função Alt + botão do meio do mouse"

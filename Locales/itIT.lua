...
--0 Restore
L["Delete icon permanently?"] = "Elimina il simbolo?"
...
L["which you removed with Alt + middle mouse button function"] = "che hai rimosso con la funzione Alt + pulsante centrale del mouse"

...
do
	...
	local function iter(t, prestate)
      ...
      --icons["PDM"] = iconLink .. "PassageDungeonM"
      --icons["PRM"] = iconLink .. "PassageDungeonM"
      --icons["PDRMM"] = iconLink .. "PassageDungeonRaidMultiM"
      --icons["PRMM"] = iconLink .. "PassageRaidMultiM"
        --if db.show.ClassicIcons then
        --  icons["PassageDungeonM"] = icons["Dungeon"]
        --  icons["PassageRaidM"] = icons["Raid"]
        --  icons["PassageDungeonRaidMultiM"] = icons["MultipleM"]
        --  icons["PassageRaidMultiM"] = icons["MultipleR"]
        --else
        --if not db.show.ClassicIcons then
        --  icons["PassageDungeonM"] = icons["PDM"]
        --  icons["PassageRaidM"] = icons["PRM"] 
        --  icons["PassageDungeonRaidMultiM"] = icons["PDRMM"] 
        --  icons["PassageRaidMultiM"] = icons["PRMM"] 
        --  end
        --end

        if (anyLocked and db.graymultipleID) or ((allLocked and not db.graymultipleID) and db.assignedgray) then  
        --if (anyLocked and db.graymultipleID) or (allLocked and db.graymultipleID) or ((allLocked and not db.graymultipleID) and db.assignedgray) then  
        icon = icons["Locked"]
      end

...
local TextIcon = IconClass
local TextIconMNL4 = TextIcon(iconLink .. "MNL4") 
local TextIconPassageDungeonM = TextIcon(iconLink .. "PassageDungeonM", 64, 64, 10, 50, 50, 1)
local TextIconPassageRaidM = TextIcon(iconLink .. "PassageRaidM", 64, 64, 10, 50, 50, 1)
local TextIconPortal = TextIcon(iconLink .. "portal", 64, 64, 10, 50, 50, 1)
local TextIconPortal = TextIcon(iconLink .. "portal", 64, 64, 10, 50, 50, 1) --(0, 0, 0, 0, 0, 0 = horizontal reflection?, ?, skalierung?, y achse,? )
local TextIconHPortal = TextIcon("Interface/Minimap/Vehicle-HordeMagePortal", 64, 64, 10, 50, 50, 1)
local TextIconAPortal = TextIcon("Interface/Minimap/Vehicle-AllianceMagePortal", 64, 64, 10, 50, 50, 1)
local TextIconDungeon = TextIcon("Interface\\MINIMAP\\Dungeon", 64, 64, 10, 50, 50, 1)
local TextIconRaid = TextIcon("Interface\\MINIMAP\\Raid", 64, 64, 10, 50, 50, 1)
local TextIconVDungeon = TextIcon(iconLink .. "vanilladungeons", 64, 64, 10, 50, 50, 1)
local TextIconVRaid = TextIcon(iconLink .. "vanilladungeons", 64, 64, 10, 50, 50, 1)
local TextIconVKey1 = TextIcon(iconLink .. "vkey1")
local TextIconMultipleM = TextIcon(iconLink .. "multipleM", 64, 64, 10, 50, 50, 1)
local TextIconMultipleD = TextIcon(iconLink .. "multipleD", 64, 64, 10, 50, 50, 1)
local TextIconMultipleR = TextIcon(iconLink .. "multipleR", 64, 64, 10, 50, 50, 1)
local TextIconLocked = TextIcon(iconLink .. "gray", 64, 64, 10, 50, 50, 1)
local TextIconZeppelin = TextIcon(iconLink .. "zeppelin")
local TextIconHZeppelin = TextIcon("interface/minimap/vehicle-air-horde")
local TextIconAZeppelin = TextIcon(iconLink .. "azeppelin")
local TextIconShip = TextIcon(iconLink .. "ship")
local TextIconHShip = TextIcon(iconLink .. "shipH")
local TextIconAShip = TextIcon(iconLink .. "shipA")
local TextIconExit = TextIcon("interface/TARGETINGFRAME/UI-RaidTargetingIcon_7", 64, 64, 10, 50, 50, 1)
local TextIconPassageup = TextIcon(iconLink .. "PassageUpL")
local TextIconPassagedown = TextIcon(iconLink .. "PassageDownL")
local TextIconPassageright = TextIcon(iconLink .. "PassageRightL")
local TextIconPassageleft = TextIcon(iconLink .. "PassageLeftL")
local TextIconTransportHelper = TextIcon(iconLink .. "tport", 64, 64, 10, 50, 50, 1)
local TextIconOgreWaygate = TextIcon("Interface/Minimap/Vehicle-AllianceWarlockPortal", 64, 64, 10, 50, 50, 1)
local TextIconCheck = TextIcon("Interface/Buttons/UI-CheckBox-Up", 64, 64, 10, 50, 50, 1)
local TextIconHorde = TextIcon("interface/pvprankbadges/pvprankhorde")
local TextIconAlliance = TextIcon("interface/pvprankbadges/pvprankalliance")
local TextIconTomTom = TextIcon(iconLink .."tomtompoint")
local TextIconJournal = TextIcon("interface/encounterjournal/ui-ej-journalbg")
local TextIconKilledBosses = TextIcon("Interface/TargetingFrame/UI-RaidTargetingIcon_8")
local TextIconKalimdor = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Female-Orc")
local TextIconEK = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Female-Human")
local TextIconBC = TextIcon("Interface/Icons/Achievement_Boss_Illidan")
local TextIconNorthrend = TextIcon("interface/lfgframe/ui-lfr-portrait")
local TextIconPandaria = TextIcon("Interface/CharacterFrame/TEMPORARYPORTRAIT-FEMALE-PANDAREN")
local TextIconDraenor = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Male-MagharOrc")
local TextIconLegion = TextIcon("Interface/Icons/artifactability_HavocDemonHunter_AnguishoftheDeceiver")
local TextIconZandalar = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Female-ZandalariTroll")
local TextIconKT = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Male-KulTiran")
local TextIconSL = TextIcon("interface/icons/achievement_leader_sylvanas")
local TextIconDF = TextIcon("Interface/CharacterFrame/TemporaryPortrait-Male-Dracthyr")
    ...
    AzerothTab = {
      ...
      args = {
        ...
        showAzerothRaid = {
          disabled = function() return not db.show["Azeroth"] end,
          type = "toggle",
          name = TextIconRaid:GetIconString() .. " " .. TextIconPassageRaidM:GetIconString() .. " " .. L["Raids"],
        ...
        showAzerothDungeon = {
          disabled = function() return not db.show["Azeroth"] end,
          type = "toggle",
          name = TextIconDungeon:GetIconString() .. " " .. TextIconPassageDungeonM:GetIconString() .. " " .. L["Dungeons"],

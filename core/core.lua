...
TextIconHShip = TextIcon(iconLink .. "shipH", 64, 64, 10, 50, 50, 1)
TextIconAShip = TextIcon(iconLink .. "shipA", 64, 64, 10, 50, 50, 1)
  ...
  if db.show.DungeonMap then
    ...
    --################################
      ...
      if self.db.profile.showDungeonPassage then
        ...
        nodes[281][29120410] = { mnID = 280, name = L["Passage"], type = "PassageRightL", showInZone = true } -- Maraudon passage to Zaetar's Grave-- Black Temple
        nodes[339][28657991] = { mnID = 340, name = L["Passage"], type = "PassageDownL", showInZone = true } -- Black Temple passage
        nodes[339][76054672] = { mnID = 341, name = L["Passage"], type = "PassageRightL", showInZone = true } -- Black Temple passage      
        nodes[340][27240693] = { mnID = 339, name = L["Passage"], type = "PassageUpL", showInZone = true } -- Black Temple passage
        nodes[341][61933384] = { mnID = 342, name = L["Passage"], type = "PassageRightL", showInZone = true } -- Black Temple passage
        nodes[341][21124985] = { mnID = 339, name = L["Passage"], type = "PassageLeftL", showInZone = true } -- Black Temple passage
        nodes[341][57859035] = { mnID = 343, name = L["Passage"], type = "PassageLeftL", showInZone = true } -- Black Temple passage
        nodes[341][26302301] = { mnID = 344, name = L["Passage"], type = "PassageDownL", showInZone = true } -- Black Temple passage
        nodes[342][63033918] = { mnID = 341, name = L["Passage"], type = "PassageLeftL", showInZone = true } -- Black Temple passage
        nodes[343][74966845] = { mnID = 341, name = L["Passage"], type = "PassageRightL", showInZone = true } -- Black Temple passage
        nodes[344][08254813] = { mnID = 341, name = L["Passage"], type = "PassageUpL", showInZone = true } -- Black Temple passage
        nodes[344][67275590] = { mnID = 345, name = L["Passage"], type = "PassageDownL", showInZone = true } -- Black Temple passage
        nodes[345][47333054] = { mnID = 346, name = L["Passage"], type = "PassageUpL", showInZone = true } -- Black Temple passage
        nodes[345][69461241] = { mnID = 344, name = L["Passage"], type = "PassageUpL", showInZone = true } -- Black Temple passage
        nodes[346][52821234] = { mnID = 345, name = L["Passage"], type = "PassageUpL", showInZone = true } -- Black Temple passage   
      end

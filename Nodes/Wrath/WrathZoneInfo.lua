...
function ns.LoadWrathZoneInfo(self)
		...
		if db.show.ZoneMap then
            ...
            -- Dungeons
                ...
                if self.db.profile.showZoneDungeons then
    			    ...
    			    nodes[1454][51524981] = { mnID = 1454, name = DUNGEON_FLOOR_RAGEFIRE1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "13-18]", dnID = REQUIRES_LABEL .. " " .. MINIMUM .. " " .. GARRISON_TIER .. " " .. "8", type = "Dungeon", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
             ...
             -- Multi
                if self.db.profile.showZoneMultiple then
                    ...
                    nodes[1446][65495000] = { mnID = 1446, name = "", dnID = DUNGEON_FLOOR_COTMOUNTHYJAL1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "70+]" .. "\n" .. DUNGEON_FLOOR_COTTHEBLACKMORASS1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "70+]" .. "\n" .. L["Old Hillsbrad Foothills"] .. " " .. "[" .. GARRISON_TIER .. ": " .. "66-68]" .. "\n" .. L["The Culling of Stratholme"] .. " " .. "[" .. GARRISON_TIER .. ": " .. "79-80]", type = "MultipleM", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
            ...
            -- Ships
                if self.db.profile.showZoneShips then
                    ...
                    if self.faction == "Alliance" or db.show.EnemyFaction then
                        ...
                        nodes[1439][34224187] = { mnID = 1438, name = "", type = "AShip", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Auberdine"] .. " - " .. FACTION_ALLIANCE .. "\n" .. "\n" .. L["Ship"] .. "\n" .. " => " .. L["Teldrassil"] } -- Ship from Booty Bay to Ratchet
            ...
            -- Portals
                if self.db.profile.showZonePortals then
                    ...
                    if self.faction == "Horde" or db.show.EnemyFaction then
                        nodes[1454][38078571] = { mnID = 1419, name = "", type = "HPortal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Blasted Lands"] }
            ...
            -- Raids            
                ...
                if self.db.profile.showZoneRaids then
				    ...
				    nodes[1428][29844778] = { mnID = 1428, name = DUNGEON_FLOOR_MOLTENCORE1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "60+]", type = "Raid", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
            ...
            -- Dungeons
                ...
                if self.db.profile.showZoneDungeons then
				    ...
				    nodes[1420][85073208] = { mnID = 1420, name = DUNGEON_FLOOR_TIRISFAL13 .. " " .. "[" .. GARRISON_TIER .. ": " .. "22-30]", dnID = REQUIRES_LABEL .. " " .. MINIMUM .. " " .. GARRISON_TIER .. " " .. "21", type = "Dungeon", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
				    nodes[1423][30771675] = { mnID = 1423, name = DUNGEON_FLOOR_COTSTRATHOLME1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "58-60]", dnID = REQUIRES_LABEL .. " " .. MINIMUM .. " " .. GARRISON_TIER .. " " .. "48", type = "Dungeon", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
                    ...
                    nodes[1942][85136422] = { mnID = 1957, name = DUNGEON_FLOOR_ZULAMAN1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "70]", dnID = REQUIRES_LABEL .. " " .. MINIMUM .. " " .. GARRISON_TIER .. " " .. "70", type = "Dungeon", showInZone = true, hideOnContinent = true, hideOnMinimap = true }

                end

                if self.db.profile.showZoneMultiple then

				    nodes[1428][29844778] = { mnID = 1428, name = "", dnID = DUNGEON_FLOOR_MOLTENCORE1 .. " " .. "[" .. GARRISON_TIER .. ": " .. "60+]" .. "\n" .. DUNGEON_FLOOR_BURNINGSTEPPES15 .. " " .. "[" .. GARRISON_TIER .. ": " .. "60+]" .. "\n" .. DUNGEON_FLOOR_BURNINGSTEPPES14 .. " " .. "[" .. GARRISON_TIER .. ": " .. "55-60]" .. "\n" .. DUNGEON_FLOOR_BURNINGSTEPPES16 .. " " .. "[" .. GARRISON_TIER .. ": " .. "52-60]", type = "MultipleM", showInZone = true, hideOnContinent = true, hideOnMinimap = true }
            ...
            -- Zone Eastern Kingdom Transport and not RemoveBlizzPOIs
                if self.db.profile.showZoneTransport then
                    ...
                    if self.faction == "Alliance" or db.show.EnemyFaction then
                        ...
                        nodes[1455][73375055] = { mnID = 1455, name = "", type = "Carriage", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Ironforge"] .. " - " .. FACTION_ALLIANCE .. "\n" .. "\n" .. DUNGEON_FLOOR_DEEPRUNTRAM1 .. "\n" .. " => " .. L["Stormwind"] } -- Transport to Ironforge Carriage 
                        nodes[1453][60941195] = { mnID = 1453, name = "", type = "Carriage", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Stormwind"] .. " - " .. FACTION_ALLIANCE .. "\n" .. "\n" .. DUNGEON_FLOOR_DEEPRUNTRAM1 .. "\n" .. " => " .. L["Ironforge"] } -- Transport to Ironforge Carriage 
            ...
            -- Ships
                if self.db.profile.showZoneShips then
                    ...
                    if self.faction == "Alliance" or db.show.EnemyFaction then
                        nodes[1437][07746089] = { mnID = 1445, name = "", type = "AShip", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = POSTMASTER_LETTER_WETLANDS .. " - " .. FACTION_ALLIANCE .. "\n" .. "\n" .. L["Ship"] .. "\n" .. " => " .. L["Theramore Isle"] } -- Ship from Menethil Harbor to Howling Fjord and Dustwallow Marsh
                    end
            ...
            --Eastern Kingdom Portals
                if self.db.profile.showZonePortals then
                    ...
                    nodes[1419][58666016] = { mnID = 1944, name = "", type = "Portal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = SPLASH_BASE_90_RIGHT_TITLE .. " => " .. L["Hellfire Peninsula"] }
        ...
        if self.db.profile.showZoneNorthrend then
            ...
            -- Northrend Portal
              if self.db.profile.showZonePortals then
                ...
                if self.faction == "Horde" or db.show.EnemyFaction then
                  nodes[125][55322545] = { mnID = 85, name = "", type = "HPortal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Portal"] .. " => " .. DUNGEON_FLOOR_ORGRIMMAR0 } -- Dalaran to Orgrimmar Portal 
                  nodes[127][31103140] = { mnID = 85, name = "", type = "HPortal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Portal"] .. " => " .. DUNGEON_FLOOR_ORGRIMMAR0 } --  Dalaran to Orgrimmar Portal
                end
        
                if self.faction == "Alliance" or db.show.EnemyFaction then
                  nodes[125][40796326] = { mnID = 84,  name = "" , type = "APortal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Stormwind"] } -- Dalaran to Stormwind City Portal
                  nodes[127][26614271] = { mnID = 84,  name = "" , type = "APortal", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Stormwind"] } --  Dalaran to Stormwind City Portal
                end
              end
            ...
            -- Northrend Zeppelin
              if self.db.profile.showZoneZeppelins then 
                ...
                if self.faction == "Horde" or db.show.EnemyFaction then
                  nodes[114][41365356] = { mnID = 85, name = "", type = "HZeppelin", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Zeppelin"] .. " => " .. DUNGEON_FLOOR_ORGRIMMAR0 } -- Zeppelin from Borean Tundra to Ogrimmar
                end
              end
            ...
            -- Northrend Ships
              if self.db.profile.showZoneShips then
                ...
                if self.faction == "Alliance" or db.show.EnemyFaction then
                  nodes[114][59636916] = { mnID = 84, name = "", type = "AShip", showInZone = true, hideOnContinent = true, hideOnMinimap = true, TransportName = L["Ship"] .. " => " .. L["Stormwind"] } -- Ship to Stormwind from Borean Tundra

      ...
      if db.activate.MiniMap then
        ...
        if self.db.profile.showMiniMapKalimdor then
            ...
            if self.db.profile.showMiniMapPaths then
                ...
                minimap[10][34655892] = { name = "", dnID = L["Path"], mnID = 65, mnID2 = 199, type = "PathL", showInZone = false, showOnContinent = false, showOnMinimap = true }
        ...
        if self.db.profile.showMiniMapEasternKingdom then
            ...
            if self.db.profile.showMiniMapPaths then
                ...
                minimap[42][23793636] = { name = "", dnID = L["Path"], mnID = 47, type = "PathLU", showInZone = false, showOnContinent = false, showOnMinimap = true }

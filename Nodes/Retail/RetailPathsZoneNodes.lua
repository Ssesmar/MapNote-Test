      ...
      if db.activate.ZoneMap then
        ...
        if self.db.profile.showZoneKalimdor then
            ...
            if self.db.profile.showZonePaths then
                ...
                nodes[10][34655892] = { name = "", dnID = L["Path"], mnID = 65, mnID2 = 199, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
        ...
        if self.db.profile.showZoneEasternKingdom then
            ...
            if self.db.profile.showZonePaths then               
                ...
                nodes[42][23793636] = { name = "", dnID = L["Path"], mnID = 47, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }

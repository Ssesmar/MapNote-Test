			...
			if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZoneFP then
                    ...
                    if self.faction == "Alliance" or db.show.EnemyFaction then
                        ...
                        nodes[1419][65402440] = { mnID = 1419, name = MINIMAP_TRACKING_FLIGHTMASTER .. " - " .. FACTION_ALLIANCE, type = "TravelA", showInZone = true, hideOnContinent = true, hideOnMinimap = true } -- Blasted Lands
